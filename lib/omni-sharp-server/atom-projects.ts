...
export class AtomProjectTracker implements IDisposable {
    ...
    private _addedObservable = Observable.from(this._addedSubject);
    private _removedSubject = new Subject<string>();
    private _removedObservable = Observable.from(this._removedSubject);

    public get added() { return this._addedObservable; }
    public get removed() { return this._removedObservable; }
