...
class NotificationHandler implements OmniSharp.IFeature {
    ...
    public activate() {
        ...
        this.disposable.add(Omni.listener.packageRestoreStarted.subscribe((e) => this.packageRestoreNotification.handlePackageRestoreStarted(e)));
        this.disposable.add(Omni.listener.packageRestoreFinished.subscribe((e) => this.packageRestoreNotification.handlePackageRestoreFinished(e)));
        this.disposable.add(Omni.listener.unresolvedDependencies.subscribe((e) => this.packageRestoreNotification.handleUnresolvedDependencies(e)));
