...
declare module Atom {
    ...
    class NotificationManager {
         ...
         * This field or method was marked private by atomdoc. Use with caution.
         */
        addSuccess(message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;

        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        addInfo(message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;

        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        addWarning(message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;

        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        addError(message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;

        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        addFatalError(message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;

        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        add(type : Notification, message : string, options? : { detail?: string; icon?: string; dismissable?: boolean; [key: string]: any; }) : Notification;
