// Type definitions for text-buffer (v8.4.1)
...
declare module TextBuffer {
    ...
    class History {
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        constructor(maxUndoEntries? : any);
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        serializeStack(stack? : any, options? : any) : any;
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        serializeSnapshot(snapshot? : any, options? : any) : any;
    ...
    class MarkerLayer {
         ...
         * This field or method was marked private by atomdoc. Use with caution.
         */
        constructor(delegate? : any, id? : any, options? : any);
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        emitChangeEvents(snapshot? : any) : void;
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        compareMarkers(id1? : any, id2? : any) : Marker[];
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        createMarker(range? : Atom.Range, params? : any) : Marker;
    
        /**
         * Internal
         * This field or method was marked private by atomdoc. Use with caution.
         */
        addMarker(id? : any, range? : Atom.Range, params? : any) : Marker;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        scheduleUpdateEvent() : any;
    ...
    class Marker {
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        constructor(id? : any, layer? : any, range? : Atom.Range, params? : any);
    ...
    class TextBuffer {
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        static deserialize(params? : any) : any;
         ...
         * @param options? - An object contaning the following keys:
         */
...
```
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        createMarkerSnapshot() : any;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        restoreFromMarkerSnapshot(snapshot? : any) : void;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        emitMarkerChangeEvents(snapshot? : any) : void;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        emitDidChangeTextEvent(patch? : Patch) : string;
         ...
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        scheduleDidStopChangingEvent() : any;
        ...
        /**
         * Private MarkerLayer Delegate Methods
         * This field or method was marked private by atomdoc. Use with caution.
         */
        markerLayerDestroyed(markerLayer? : Marker) : Marker;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        markerCreated(layer? : any, marker? : Marker) : Marker;
    
        /**
         * This field or method was not documented by atomdoc, assume it is private. Use with caution.
         */
        markersUpdated(layer? : any) : Marker;
